...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "com.lesikapk.opengelplus.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.lesikapk.opengelplus.permission.RECEIVE_LAUNCH_BROADCASTS";
